...
<div id="layout">
	...
	<div id="main">
        ...
        <div class="content">
            <form action="/edit/{{ page_title.replace(' ', '_') }}" method="post" class="pure-form">
...
prismcss = """/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript */
/**
