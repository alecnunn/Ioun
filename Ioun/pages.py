...
.pure-input-1 {line-height:12px;font-family: monospace;}
"""
...
<a href="/"><button class="button-error pure-button">No</button></a>
</center>
"""
...
<div id="layout">
	...
	<div id="main">
        ...
        <div class="content">
            {{! content }}
            <div id="foo">
                <button class="button-success pure-button" onclick="createPage()">Add Page</button>
            % if page_title != 'Ioun':
                <a href="/edit/{{ page_title.replace(' ', '_') }}"><button class="button-secondary pure-button">Edit Page</button></a>
            % end
            </div>
        </div>
	</div>
...
<script>
function createPage() {
    var pageTitle = prompt("What do you want to name this page?", "Default Title");
    if(pageTitle != null) {
        window.location.assign("http://" + window.location.hostname + ":8080/wiki/" + pageTitle.replace(/ /g,"_"));
    }
}
